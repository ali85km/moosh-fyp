		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcCommitment ("
						...
						+ "formtccommitment_question6, "
						+ "formtccommitment_question7" + ") VALUES ('"
		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcContact ("
						...
						+ "formtccontact_emailreceive, "
						+ "formtccontact_emailreply, "
						+ "formtccontact_phonereceive, "
						+ "formtccontact_phonereply, "
						+ "formtccontact_smsreceive, "
						+ "formtccontact_smsreply" + ") VALUES (1, 1" + ", '"
						+ contact1.getEmailReceive() + "', '"
						+ contact1.getEmailReplay() + "', '"
						+ contact1.getPhoneReceive() + "', '"
						+ contact1.getPhoneReplay() + "', '"
						+ contact1.getSmsReceive() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcContact ("
						...
						+ "formtccontact_smsreceive, "
						+ "formtccontact_smsreply" + ") VALUES (1, 1" + ", '"
						+ contact2.getEmailReceive() + "', '"
						+ contact2.getEmailReplay() + "', '"
						+ contact2.getPhoneReceive() + "', '"
						+ contact2.getPhoneReplay() + "', '"
						+ contact2.getSmsReceive() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcContact ("
						...
						+ "formtccontact_smsreceive, "
						+ "formtccontact_smsreply" + ") VALUES (1, 1" + ", '"
						+ contact3.getEmailReceive() + "', '"
						+ contact3.getEmailReplay() + "', '"
						+ contact3.getPhoneReceive() + "', '"
						+ contact3.getPhoneReplay() + "', '"
						+ contact3.getSmsReceive() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcContact ("
						...
						+ "formtccontact_smsreceive, "
						+ "formtccontact_smsreply" + ") VALUES (1, 1" + ", '"
						+ contact4.getEmailReceive() + "', '"
						+ contact4.getEmailReplay() + "', '"
						+ contact4.getPhoneReceive() + "', '"
						+ contact4.getPhoneReplay() + "', '"
						+ contact4.getSmsReceive() + "', '"
		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcEquipment ("
						...
						+ "formtcequipment_computer, "
						+ "formtcequipment_desk, "
						+ "formtcequipment_facsimile"
						+ "formtcequipment_filecabinet, "
						+ "formtcequipment_modem, " + "formtcequipment_pager, "
						+ "formtcequipment_printer, "
						+ "formtcequipment_software, "
						+ "formtcequipment_typewriter, "
						+ "formtcequipment_voicemail"
		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcMeeting ("
						...
						+ "formtcmeeting_audiototal, "
						+ "formtcmeeting_audioattend, "
						+ "formtcmeeting_videototal, "
						+ "formtcmeeting_videoattend, "
						+ "formtcmeeting_facetofaceconduct, "
						+ "formtcmeeting_facetofaceattend" + ") VALUES (1, 1"
						+ ", '" + meeting1.getAudioConduct() + "', '"
						+ meeting1.getAudioAttend() + "', '"
						+ meeting1.getVideoConduct() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcMeeting ("
						...
						+ "formtcmeeting_facetofaceattend" + ") VALUES (1, 1"
						+ ", '" + ") VALUES (1, 1" + ", '"
						+ meeting2.getAudioConduct() + "', '"
						+ meeting2.getAudioAttend() + "', '"
						+ meeting2.getVideoConduct() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcMeeting ("
						...
						+ "formtcmeeting_facetofaceattend" + ") VALUES (1, 1"
						+ ", '" + ") VALUES (1, 1" + ", '"
						+ meeting3.getAudioConduct() + "', '"
						+ meeting3.getAudioAttend() + "', '"
						+ meeting3.getVideoConduct() + "', '"
				...
				statement.executeUpdate("INSERT INTO FormTcMeeting ("
						...
						+ "formtcmeeting_facetofaceattend" + ") VALUES (1, 1"
						+ ", '" + ") VALUES (1, 1" + ", '"
						+ meeting4.getAudioConduct() + "', '"
						+ meeting4.getAudioAttend() + "', '"
						+ meeting4.getVideoConduct() + "', '"
		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcWorkHours ("
						+ "formtcweekworkhours_serie, "
						+ "formtcweekworkhours_week, "
		...
		try {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO FormTcWorkLife ("
						+ "formtcworklife_question1, "
						+ "formtcworklife_question2, "
						+ "formtcworklife_question3, "
						+ "formtcworklife_question4, " + ") VALUES ('"
						+ form.getQuestion1().getChoice() + "', '"
						+ form.getQuestion2().getChoice() + "', '"
						+ form.getQuestion3().getChoice() + "', '"
						+ form.getQuestion4().getChoice() + "');");
