...
<body>
	<table width="816" height="280" border="4" align="center">
		<tr>
			<td width="800"><img src="rsc/Title.jpg" width="800"
				height="155" /></td>
		</tr>
		<tr>
			<td background="rsc/TableBG.jpg"><p>&nbsp;</p>
				...
				<p align="center">&nbsp;</p>
				<p align="center">Please select the number of emails, phone calls
					and SMS that you have recived and replied.</p>
				<p align="center">&nbsp;</p>


				<table width="739" height="296" border="4" align="center">
					<tr>
					...
					<tr>
						<td width="109" height="66"><div align="center"></div></td>
						<td><div align="center">Total Receives</div></td>
						<td><div align="center">Total Reply</div></td>
						<td>&nbsp;</td>
						<td><div align="center">
								<div align="center">Total Receives</div>
							</div></td>
						<td><div align="center">
								<div align="center">Total Reply</div>
							</div></td>
						<td>&nbsp;</td>
						<td><div align="center">
								<div align="center">Total Receives</div>
					...
					<tr>
						...
						<td><div align="center">
								<select name="select22" id="select22">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
						...
						<td>&nbsp;</td>
						<td><div align="center">
								<select name="select23" id="select23">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
						...
						<td><div align="center">
								<select name="select24" id="select24">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
